...
public class Learner_JMM {
    ...
    public void CompareGridWorld(){
        ...
        // I at 12 (test with 6 / 14 takes a long time)
        for (int i = 2; i <=14; i+=2){
            System.out.println("START grid#: " + i);
            System.out.println("\n");
            InitGridWorld(i);
            DoValueIteration(data1);
            DoPolicyIteration(data2);
            System.out.println("END  grid#: " + i);
            System.out.println("\n");
        }
    ...
    public void DoValueIteration(AnalysisData data){
        int maxk = 10;
        double time = 0;
    ...
    public void DoPolicyIteration(AnalysisData data){
        int maxk = 10;
        double time = 0;
        ...
        if (!outputPath.equals("")) {
            ep.write(outputPath + "pi");
            //ValueFunctionVisualization((ValueFunction) planner, p);
        }
    }

    public void DoQLearning(String expName, int iterations){
        ...
        for (int k = 0; k < maxk; k++) {
            ...
            if (k == maxk-1) {
                //ValueFunctionVisualization((ValueFunction) agent, new GreedyQPolicy((QProvider) agent));
    ...
    public static void MDP1Test(){
        ...
        learner.DoValueIteration(null);
        learner.DoPolicyIteration(null);
        learner.DoQLearning("MDP1", 50);
